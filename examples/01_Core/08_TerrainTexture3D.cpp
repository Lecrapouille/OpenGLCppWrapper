...
TerrainTexture3D::TerrainTexture3D()
  : m_vao("VAO_terrain"),
    m_prog("prog")
{
  std::cout << "Hello TerrainTexture3D" << std::endl;
}
...
//------------------------------------------------------------------------------
void TerrainTexture3D::onWindowSizeChanged()
{
...
bool TerrainTexture3D::setup()
{
  ...
  m_vertex_shader.fromFile("01_Core/shaders/08_TerrainTexture3D.vs");
  m_fragment_shader.fromFile("01_Core/shaders/08_TerrainTexture3D.fs");
...
//------------------------------------------------------------------------------
bool TerrainTexture3D::draw()
{
  // Clear OpenGL color and depth buffers.
  glCheck(glClearColor(0.0f, 0.0f, 0.4f, 0.0f));
  glCheck(glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT));

  // Note: 0 and m_nbVertices are implicit
