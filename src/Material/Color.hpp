...
public:
  ...
  //----------------------------------------------------------------------------
  Color(float const red, float const green, float const blue, float const alpha = 1.0f)
  {
  ...
  //----------------------------------------------------------------------------
  Color(uint8_t const red, uint8_t const green, uint8_t const blue, uint8_t const alpha = 255U)
  {
